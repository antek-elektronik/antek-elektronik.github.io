...
function UpdateScoreDisplay(){ 
    ...
    document.getElementById("scoreDisplay").innerHTML = score + " głosów";
    ...
    if(score > 1000){
        document.getElementById("win").innerHTML = "Wygrana! Możesz zawsze grać dalej w nieskończoność. 26 października zagraj w tę grę na żywo i zagłosuj na mnie w wyborach do młodzieżowej rady internatu! Dzięki! <br><br><br>Z pomocą Antka Gzary zdziałamy czary!"
    }
